"""Script to create field_config_service.py"""
...
with open('src/services/field_config_service.py', 'w', encoding='utf-8') as f:
    f.write(content)

print(f"File created successfully! Size: {len(content)} bytes")
