"""Script to create the backup_restore_utility.py file"""
...
# Write the file
with open('backup_restore_utility.py', 'w', encoding='utf-8') as f:
    f.write(BACKUP_UTILITY_CODE)

print("✅ Created backup_restore_utility.py")
